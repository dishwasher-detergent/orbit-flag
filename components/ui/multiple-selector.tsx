  ...
  (
    ...
    return (
      ...
      >
        ...
        >
          <div className="relative flex h-full flex-wrap items-center gap-1 px-2">
            {selected.map((option) => {
              return (
                <Badge
                  key={option.value}
                  ...
                  className={cn(
                    ...
                    "data-fixed:bg-muted-foreground data-fixed:text-muted data-fixed:hover:bg-muted-foreground text-wrap whitespace-normal",
                    badgeClassName
                  )}
                ...
                >
                  ...
                  <button
                    className={cn(
                      "ring-offset-background focus:ring-ring ml-2 rounded-full outline-hidden focus:ring-2 focus:ring-offset-2",
                  ...
                  >
                    <LucideX className="text-foreground size-3" />
                  </button>
                </Badge>
              );
            })}
